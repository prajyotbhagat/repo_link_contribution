...
# ──────────────────────────────────────────────────────────────────────────────
# Email — production SMTP (Resend, SendGrid, etc.)
# Required env vars: EMAIL_HOST_USER, EMAIL_HOST_PASSWORD, DEFAULT_FROM_EMAIL
# ──────────────────────────────────────────────────────────────────────────────

# Always use real SMTP in production — never the console dummy backend.
...
DEFAULT_FROM_EMAIL = os.getenv(
    'DEFAULT_FROM_EMAIL',
    'RepoRadar <noreply@reporadar.app>'
)
